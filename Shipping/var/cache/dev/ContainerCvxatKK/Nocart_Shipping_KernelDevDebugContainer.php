 ...
 */
class Nocart_Shipping_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Nocart\\Shipping\\Ports\\Http\\HealthController' => 'getHealthControllerService',
            'Nocart\\Shipping\\Ports\\Http\\ShippingController' => 'getShippingControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Nocart\\Shipping\\Kernel', 'Nocart\\Shipping\\Ports\\Http\\HealthController', 'Nocart\\Shipping\\Ports\\Http\\ShippingController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Nocart_Shipping_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Nocart_Shipping_KernelDevDebugContainer',
