 ...
 */
class Nocart_Checkout_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Nocart\\Checkout\\Ports\\Http\\CheckoutController' => 'getCheckoutControllerService',
            'Nocart\\Checkout\\Ports\\Http\\HealthController' => 'getHealthControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Nocart\\Checkout\\Kernel', 'Nocart\\Checkout\\Ports\\Http\\CheckoutController', 'Nocart\\Checkout\\Ports\\Http\\HealthController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Nocart_Checkout_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Nocart_Checkout_KernelDevDebugContainer',
