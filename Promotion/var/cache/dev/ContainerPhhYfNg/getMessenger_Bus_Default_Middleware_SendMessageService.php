 ...
 */
class getMessenger_Bus_Default_Middleware_SendMessageService extends Nocart_Promotion_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.Bs_IQhr'] ?? $container->load('get_ServiceLocator_BsIQhrService'));
        ...
        $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['Nocart\\SharedKernel\\Infrastructure\\Messenger\\Message\\ExternalEventMessage' => ['kafka_consumer']], $a), $b, true);
