 ...
 */
class getRouting_LoaderService extends Nocart_Services_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'kernel' => 'Nocart\\Services\\Kernel',
        ]), 'dev'));
        $a->addLoader($c);
        $a->addLoader(new \Symfony\Component\Routing\Loader\AttributeServicesLoader(['Nocart\\Services\\Ports\\Http\\HealthController', 'Nocart\\Services\\Ports\\Http\\ServicesController']));
