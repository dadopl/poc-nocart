 ...
 */
class Nocart_Services_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Nocart\\Services\\Ports\\Http\\HealthController' => 'getHealthControllerService',
            'Nocart\\Services\\Ports\\Http\\ServicesController' => 'getServicesControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Nocart\\Services\\Kernel', 'Nocart\\Services\\Ports\\Http\\HealthController', 'Nocart\\Services\\Ports\\Http\\ServicesController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Nocart_Services_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Nocart_Services_KernelDevDebugContainer',
