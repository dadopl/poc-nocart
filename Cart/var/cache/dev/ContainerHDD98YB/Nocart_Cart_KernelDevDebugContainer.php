 ...
 */
class Nocart_Cart_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Nocart\\Cart\\Ports\\Http\\CartController' => 'getCartControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Nocart\\Cart\\Kernel', 'Nocart\\Cart\\Ports\\Http\\CartController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Nocart_Cart_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Nocart_Cart_KernelDevDebugContainer',
