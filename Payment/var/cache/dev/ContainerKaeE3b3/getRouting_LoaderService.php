 ...
 */
class getRouting_LoaderService extends Nocart_Payment_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'kernel' => 'Nocart\\Payment\\Kernel',
        ]), 'dev'));
        $a->addLoader($c);
        $a->addLoader(new \Symfony\Component\Routing\Loader\AttributeServicesLoader(['Nocart\\Payment\\Ports\\Http\\HealthController', 'Nocart\\Payment\\Ports\\Http\\PaymentController']));
