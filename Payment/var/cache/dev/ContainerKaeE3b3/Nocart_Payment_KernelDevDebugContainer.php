 ...
 */
class Nocart_Payment_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Nocart\\Payment\\Ports\\Http\\HealthController' => 'getHealthControllerService',
            'Nocart\\Payment\\Ports\\Http\\PaymentController' => 'getPaymentControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Nocart\\Payment\\Kernel', 'Nocart\\Payment\\Ports\\Http\\HealthController', 'Nocart\\Payment\\Ports\\Http\\PaymentController']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Nocart_Payment_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Nocart_Payment_KernelDevDebugContainer',
